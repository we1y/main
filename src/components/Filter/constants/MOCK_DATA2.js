...
},
{
    ...
    pr: 'Юриспруденция',
    ot: 'Образование и социальная среда',
    time: <p>2 года 10 месяцев - 3 года 10 месяцев</p>,
    form: 
    <ul>
        <li>Очная</li>
        <li>Заочная</li>

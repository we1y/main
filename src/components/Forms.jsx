...
export default function Forms() {
    ...
    const buttons = [
      ...
      { id: 2, label: 'Очно-заочная', text: 'На первом этапе обучающийся осваивает базовые знания, умения, компетенции путем изучения учебно-методической литературы и иных информационных ресурсов (установочная сессия), на втором - преподаватель проводит проверку освоенного обучающимся материала. Эти этапы, как правило, определяются в соответствии с графиком учебного процесса образовательной программы' },
      { id: 3, label: 'Заочная', text: 'Форма обучения предполагает посещение обучающимися занятий от двух до четырех раз в неделю и систематические аудиторные занятия (лекции, семинары, практические занятия и пр.) в течение всего учебного года' },
    ];
